...
static int sde_backlight_device_update_status(struct backlight_device *bd)
{
	...
	/*modified by webber for task 32828: brightness can be modified--start*/
	if (brightness > display->panel->bl_config.brightness_max_level)
		brightness = display->panel->bl_config.brightness_max_level;
	/*modified by webber for task 32828: brightness can be modified--end*/
...
/*Modified by PICO_Driver dean.ji for bug 65664 : 增加复位DSI功能  --start--*/
    if (sde_connector->ops.check_status &&
		(info.capabilities & MSM_DISPLAY_ESD_ENABLED))
...
/*Modified by PICO_Driver dean.ji for bug 65664 : 增加复位DSI功能  --end--*/
