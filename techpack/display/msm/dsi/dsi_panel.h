...
enum dsi_backlight_type {
	...
	DSI_BACKLIGHT_WLED,
	DSI_BACKLIGHT_DCS,
	DSI_BACKLIGHT_GPIO,/*added by webber for task 32828: brightness can be modified*/
...
struct dsi_backlight_config {
	...
	int pwm_gpio;
	int bklt_brightness_gpio[3];/*added by webber for task 32828: brightness can be modified*/
...
struct dsi_panel {
	...
	/* Added by gavin.zhao for bug_38463 set backlight -- start */
	struct mutex backlight_lock;
	/* Added by gavin.zhao for bug_38463 set backlight -- end */
	/* Added by gavin.zhao for bug_42533 pwm backlight -- start */
        struct pwm_device     *lcd_pwm;
	/* Added by gavin.zhao for bug_42533 pwm backlight -- end */
	...
	struct dsi_regulator_info chahei_power_info;/*added by webber.wang for Bug 38813:unbalanced ldo 22*/
	...
	int panel_test_gpio;
	int panel_vio_gpio;              //added by gavin.zhao for lcd vio enable 
	int panel_blk_gpio;              //added by gavin.zhao for lcd blk enable 
	int power_mode;
...
int dsi_panel_neo_update_backlight(struct dsi_panel *panel, u32 bl_lvl_1, u32 bl_lvl_2, u32 fps);
