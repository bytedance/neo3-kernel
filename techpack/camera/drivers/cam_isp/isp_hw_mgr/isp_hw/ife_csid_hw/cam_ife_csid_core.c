		...
		struct cam_ife_csid_hw   *csid_hw, void *cmd_args)
{
	...
	//CAM_ERR(CAM_ISP, " Fsin_sof  index:%lld ,time_stamp_val:%lld ",soc_info->index, time_stamp->time_stamp_val);//6 is eye master ,5 is eye slave ,1,2,3,4 are 6dof cameras
