...
/* Modify by PICO_Driver gavin.zhao for bug_32083 DCP charger current :1.5A->2.0A --start--*/
#define DCP_CURRENT_UA                  2000000
/* Modify by PICO_Driver gavin.zhao for bug_32083 DCP charger current :1.5A->2.0A --end--*/
...
struct smb_charger {
	...
	int			last_wls_vout;
	/* Added by gavin.zhao for bug_47232 set battery FCC for different temp --start--*/
	struct timer_list       bat_temp_timer;
	struct delayed_work 	temp_detect_work;
	/* Added by gavin.zhao for bug_47232 set battery FCC for different temp --end--*/
...
/* Added by gavin.zhao for task_58666 DC_IN charging debug --begin */
	int                    dc_input_change_gpio;
	unsigned int           dc_input_change_irq;
	int                    dc_input_change_status;
