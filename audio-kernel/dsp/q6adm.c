...
/*Added by PICO_Driver jim.qiu for task64617 : one rom adapts base and pro  --start--*/
#include <linux/hardware_version.h>
/*Added by PICO_Driver jim.qiu for task64617 : one rom adapts base and pro  --end--*/
